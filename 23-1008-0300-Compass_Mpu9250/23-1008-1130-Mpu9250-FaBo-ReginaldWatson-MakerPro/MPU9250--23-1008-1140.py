# jwc 23-1008-1140 /usr/local/lib/python3.9/dist-packages/FaBo9Axis_MPU9250/MPU9250.py
...
if __name__ == "__main__":
    ...
    while True:
        ...
        ###jwc o print "ax = ", (accel['x'])
        ###jwc o print "ay = ", (accel['y'])
        ###jwc o print "az = ", (accel['z'])
        print (" ax = " , ( accel['x'] ))
        print (" ay = " , ( accel['y'] ))
        print (" az = " , ( accel['z'] ))

        gyro = mpu9250.readGyro()
        ###jwc o print "gx = ", (gyro['x'])
        ###jwc o print "gy = ", (gyro['y'])
        ###jwc o print "gz = ", (gyro['z'])
        print (" gx = " , ( gyro['x'] ))
        print (" gy = " , ( gyro['y'] ))
        print (" gz = " , ( gyro['z'] ))

        mag = mpu9250.readMagnet()
        ###jwc o print "mx = ", (mag['x'])
        ###jwc o print "my = ", (mag['y'])
        ###jwc o print "mz = ", (mag['z'])
