    ...
    if len(corners) > 0:
        ...
        for (markerCorner, markerID) in zip(corners, ids):
            ...
            if markerID == 1:                
                ...
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorLeft].angle=70
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorRight].angle=70
                print("*** MarkerID: "+ str(markerID))
                sleep(timeDuration)
            if markerID == 2:                
                ###servoKit_Object.servo[servoKit_Pca9685_Pin_MotorLeft].angle=120
            ...
            if markerID == 3:                
                ###servoKit_Object.servo[servoKit_Pca9685_Pin_MotorLeft].angle=60
                ###servoKit_Object.servo[servoKit_Pca9685_Pin_MotorRight].angle=120
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorLeft].angle=80
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorRight].angle=120
                print("*** MarkerID: "+ str(markerID))
                sleep(timeDuration)
            if markerID == 4:                
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorLeft].angle=90
                servoKit_Object.servo[servoKit_Pca9685_Pin_MotorRight].angle=90
                print("*** MarkerID: "+ str(markerID))
                sleep(timeDuration)
